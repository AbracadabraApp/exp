-- Travel Experience Cards Database Schema
-- Lists are cards: one table holds both experience-cards and list-cards
-- Architecture: member_card_ids array (not junction table) for current scale (<1000 cards)
